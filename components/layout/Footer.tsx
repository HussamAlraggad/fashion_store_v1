      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="font-body text-sm text-luxury-gray max-w-md leading-relaxed">
            ...
            <div className="mt-4 flex gap-4">
              <span className="text-xs text-luxury-gray tracking-wider uppercase">
                Est. 1985
              </span>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/products"
                  className="font-body text-sm text-luxury-gray hover:text-luxury-ivory transition-colors"
                >
                  All Collection
                </Link>
              </li>
        ...
        <div className="mt-12 pt-8 border-t border-luxury-gray/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-body text-xs text-luxury-gray/60">
            &copy; {new Date().getFullYear()} Maison Fourrure. All rights
            reserved.
          </p>
          <div className="flex gap-6 text-xs text-luxury-gray/60">
            <span>Privacy Policy</span>
            <span>Terms of Service</span>
            <span>CITES Compliance</span>
          </div>
        </div>
      </div>
    </footer>
